...
class AdministrarUSWidget extends StatefulWidget {
  ...
  @override
  State<AdministrarUSWidget> createState() => _AdministrarUSWidgetState();
}

class _AdministrarUSWidgetState extends State<AdministrarUSWidget>
    with TickerProviderStateMixin {
  late AdministrarUSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdministrarUSModel());
  ...
  Widget build(BuildContext context) {
    User? usuario = Get.arguments as User?;
    if (usuario != null) {
      _model.idTextController?.text = usuario.id.toString();
      _model.nameTextController?.text = usuario.nombre;
      _model.emailAddressTextController?.text = usuario.email;
      _model.passwordTextController?.text = usuario.password.toString();
    }
